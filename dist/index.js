...
`,Image$2=styled.img`
    ...
    max-width: 100%;
    max-height: 100%;
`,Image=({imgUrl:t,imageContainerStyle:e,imageStyle:r})=>{const n=useRef(null),[a,i]=useRecoilState(statusAtom);return useEffect(()=>{var e;(null==(e=n.current)?void 0:e.src)===t&&a.isLoading&&!a.isMounted&&i(e=>Object.assign(Object.assign({},e),{isLoading:!1,isMounted:!0}))},[a,n]),React.createElement(React.Fragment,null,a.isLoading&&React.createElement(Loader,null),React.createElement(ImageContainer,{style:e},React.createElement(Image$2,{ref:n,src:t,onLoad:()=>{var t=!1;i(e=>Object.assign(Object.assign({},e),{isLoading:t,isMounted:!0}))},style:r})))};var Image$1=memo(Image);const DEFAULT_INTERVAL=3e3,timerInitialState={interval:DEFAULT_INTERVAL,timeTracker:0},timerAtom=atom({key:"timer",default:timerInitialState}),VideoContainer=styled.div`
  height: 100%;
  width: auto;
  display: flex;
  justify-content: center;
...
`,CloseIcon=styled(SvgXmarkSolid)`
  ...
  height: ${pxToRem(20)};
  filter: drop-shadow(0 0px 3px rgba(0, 0, 0, 0.9));
`,Close=({closeCallback:e})=>React.createElement(ClsoeContainer,null,React.createElement(CloseIcon,{onClick:e}));var Close$1=memo(Close);const Stories=r=>{var e;const n=useSetRecoilState(storyAtom),a=useRecoilValue(storiesSelector),i=useSetRecoilState(timerAtom),[o,s]=useRecoilState(statusAtom),l=useRef(null),[t,c]=useState(!1);useEffect(()=>{__awaiter(void 0,void 0,void 0,function*(){c(!0);const t=yield refreshRate({sampleCount:130});c(!1),n(r),s(e=>{return Object.assign(Object.assign({},e),{isLoading:!0,isMounted:!1,total:null!=(e=r.stories.length)?e:0,fps:t})}),i(e=>{return Object.assign(Object.assign({},e),{timeTracker:0,interval:null!=(e=r.interval)?e:DEFAULT_INTERVAL})})})},[r]);var d=e=>{l.current=setTimeout(()=>{s(e=>Object.assign(Object.assign({},e),{isPaused:!0,status:"paused"}))},200)};var u=t=>e=>{e.preventDefault(),l.current&&clearTimeout(l.current),"paused"===o.status?s(e=>Object.assign(Object.assign({},e),{status:"playing"})):("next"===t&&(o.currentIndex<o.total-1?(i(e=>{var t;return{interval:"img"===a[o.currentIndex+1].type?null!=(t=r.interval)?t:DEFAULT_INTERVAL:e.interval,timeTracker:0}}),s(e=>Object.assign(Object.assign({},e),{currentIndex:e.currentIndex+1,isLoading:!0,isMounted:!1}))):o.isLoading||null==(e=r.nextCallback)||e.call(r)),"previous"===t&&(0<o.currentIndex?(i(e=>{var t;return{interval:"img"===a[o.currentIndex-1].type?null!=(t=r.interval)?t:DEFAULT_INTERVAL:e.interval,timeTracker:0}}),s(e=>Object.assign(Object.assign({},e),{currentIndex:e.currentIndex-1,isLoading:!0,isMounted:!1}))):o.isLoading||null==(e=r.previousCallback)||e.call(r)))};return React.createElement(StoryBody,{style:r.storyBodyStyle},React.createElement(Close$1,{closeCallback:r.closeCallback}),React.createElement(Progress,{nextCallback:r.nextCallback,interval:null!=(e=r.interval)?e:DEFAULT_INTERVAL}),React.createElement(StoryRenderer,{displayLoader:r.displayLoader||t,headingStyle:r.headingStyle,bottomContainerStyle:r.bottomContainerStyle,bottomTextStyle:r.bottomTextStyle}),React.createElement(StoryControlsOverlay,null,React.createElement(StoryControls,{onMouseDown:d,onMouseUp:u("previous"),onTouchStart:d,onTouchEnd:u("previous")}),React.createElement(StoryControls,{onMouseDown:d,onMouseUp:u("next"),onTouchStart:d,onTouchEnd:u("next")})))};function MyStories(e){return React.createElement(RecoilRoot,null,React.createElement(Stories,Object.assign({},e)))}export{MyStories as default};
