...
`,Image$2=styled.img`
    ...
    max-width: 100%;
    max-height: 100%;
`,Image=({imgUrl:t,imageContainerStyle:e,imageStyle:r})=>{const a=useRef(null),[n,i]=useRecoilState(statusAtom);return useEffect(()=>{var e;(null==(e=a.current)?void 0:e.src)===t&&n.isLoading&&!n.isMounted&&i(e=>Object.assign(Object.assign({},e),{isLoading:!1,isMounted:!0}))},[n,a]),React.createElement(React.Fragment,null,n.isLoading&&React.createElement(Loader,null),React.createElement(ImageContainer,{style:e},React.createElement(Image$2,{ref:a,src:t,onLoad:()=>{var t=!1;i(e=>Object.assign(Object.assign({},e),{isLoading:t,isMounted:!0}))},style:r})))};var Image$1=memo(Image);const DEFAULT_INTERVAL=3e3,timerInitialState={interval:DEFAULT_INTERVAL,timeTracker:0},timerAtom=atom({key:"timer",default:timerInitialState}),VideoContainer=styled.div`
  height: 100%;
  width: auto;
  display: flex;
  justify-content: center;
